...
src/orbi/policy/field_policy.py   whitelist por (papel, tool) — custo some aqui
...
| P8 uma tool por turno | `test_llm.py` + `test_architecture.py::test_the_erp_result_never_goes_back_to_the_llm` |
